...
class LangfuseMedia:
    obj: object
    def __init__(self, *, obj: object | None = None, base64_data_uri: str | None = None, content_type: MediaContentType | None = None, content_bytes: bytes | None = None, file_path: str | None = None) -> None: ...
    @staticmethod
