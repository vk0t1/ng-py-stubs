...
def default_types_mapper(date_as_object: bool = False, bool_dtype: Any | None = None, int_dtype: Any | None = None, float_dtype: Any | None = None, string_dtype: Any | None = None, date_dtype: Any | None = None, datetime_dtype: Any | None = None, time_dtype: Any | None = None, timestamp_dtype: Any | None = None, range_date_dtype: Any | None = None, range_datetime_dtype: Any | None = None, range_timestamp_dtype: Any | None = None): ...
...
def dataframe_to_parquet(dataframe, bq_schema, filepath, parquet_compression: str = 'SNAPPY', parquet_use_compliant_nested_type: bool = True) -> None: ...
...
def download_arrow_bqstorage(project_id, table, bqstorage_client, preserve_order: bool = False, selected_fields: Incomplete | None = None, max_queue_size=..., max_stream_count: Incomplete | None = None): ...
def download_dataframe_bqstorage(project_id, table, bqstorage_client, column_names, dtypes, preserve_order: bool = False, selected_fields: Incomplete | None = None, max_queue_size=..., max_stream_count: Incomplete | None = None): ...
