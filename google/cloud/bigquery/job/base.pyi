...
class _AsyncJob(google.api_core.future.polling.PollingFuture):
    ...
    def exists(
        self, client: Incomplete | None = None, retry: retries.Retry = ..., timeout: float | None = None
    ) -> bool: ...
    def reload(self, client: Incomplete | None = None, retry: retries.Retry = ..., timeout: float | None = ...): ...
    def cancel(
        self, client: Incomplete | None = None, retry: retries.Retry | None = ..., timeout: float | None = None
    ) -> bool: ...
