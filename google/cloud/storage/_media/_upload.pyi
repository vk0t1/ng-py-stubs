...
from google.cloud.storage.exceptions import DataCorruption as DataCorruption, InvalidResponse as InvalidResponse
...
class ResumableUpload(UploadBase):
    def __init__(self, upload_url, chunk_size, checksum: str = 'auto', headers: Incomplete | None = None, retry=...) -> None: ...
    @property
    def invalid(self): ...
    @property
    def chunk_size(self): ...
    ...
    def initiate(self, transport, stream, metadata, content_type, total_bytes: Incomplete | None = None, stream_final: bool = True, timeout: Incomplete | None = None) -> None: ...
...
class XMLMPUContainer(UploadBase):
    def __init__(self, upload_url, filename, headers: Incomplete | None = None, upload_id: Incomplete | None = None, retry=...) -> None: ...
    @property
    def upload_id(self): ...
...
class XMLMPUPart(UploadBase):
    def __init__(self, upload_url, upload_id, filename, start, end, part_number, headers: Incomplete | None = None, checksum: str = 'auto', retry=...) -> None: ...
    @property
