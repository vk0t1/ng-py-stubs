...
def t_function_responses(function_responses: types.FunctionResponseOrDict | Sequence[types.FunctionResponseOrDict]) -> list[types.FunctionResponse]: ...
...
def t_contents_for_embed(client: _api_client.BaseApiClient, contents: list[types.Content] | list[types.ContentDict] | ContentType) -> list[str] | list[types.Content]: ...
def t_contents(client: _api_client.BaseApiClient, contents: types.ContentListUnion | types.ContentListUnionDict | types.Content | None) -> list[types.Content]: ...
