...
def format_destination(
    src: str, config: types.CreateBatchJobConfigOrDict | None = None
...
def convert_number_values_for_function_call_args(
    args: dict[str, object] | list[object] | object,
...
def get_function_response_parts(
    response: types.GenerateContentResponse, function_map: dict[str, Callable]
) -> list[types.Part]: ...
