...
class Patient(domainresource.DomainResource):
    ...
    animal: fhirtypes.PatientAnimalType | None
...
class PatientAnimal(backboneelement.BackboneElement):
    __resource_type__: str
    breed: fhirtypes.CodeableConceptType | None
    genderStatus: fhirtypes.CodeableConceptType | None
    species: fhirtypes.CodeableConceptType
    @classmethod
    def elements_sequence(cls): ...
