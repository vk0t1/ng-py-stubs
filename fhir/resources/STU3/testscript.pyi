...
class TestScript(domainresource.DomainResource):
    ...
    rule: list[fhirtypes.TestScriptRuleType] | None
    ruleset: list[fhirtypes.TestScriptRulesetType] | None
...
class TestScriptMetadataCapability(backboneelement.BackboneElement):
    __resource_type__: str
    capabilities: fhirtypes.ReferenceType
...
class TestScriptRule(backboneelement.BackboneElement):
    __resource_type__: str
    param: list[fhirtypes.TestScriptRuleParamType] | None
...
class TestScriptRuleset(backboneelement.BackboneElement):
    __resource_type__: str
    resource: fhirtypes.ReferenceType
    rule: list[fhirtypes.TestScriptRulesetRuleType]
    @classmethod
    def elements_sequence(cls): ...

class TestScriptRulesetRule(backboneelement.BackboneElement):
    __resource_type__: str
    param: list[fhirtypes.TestScriptRulesetRuleParamType] | None
    ruleId: fhirtypes.IdType | None
    ruleId__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    @classmethod
    def elements_sequence(cls): ...
    def get_required_fields(self) -> list[tuple[str, str]]: ...
...
class TestScriptSetupActionAssert(backboneelement.BackboneElement):
    ...
    rule: fhirtypes.TestScriptSetupActionAssertRuleType | None
    ruleset: fhirtypes.TestScriptSetupActionAssertRulesetType | None
...
class TestScriptSetupActionAssertRule(backboneelement.BackboneElement):
    __resource_type__: str
    param: list[fhirtypes.TestScriptSetupActionAssertRuleParamType] | None
    ruleId: fhirtypes.IdType | None
    ruleId__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    @classmethod
    def elements_sequence(cls): ...
...
class TestScriptSetupActionAssertRuleset(backboneelement.BackboneElement):
    __resource_type__: str
    rule: list[fhirtypes.TestScriptSetupActionAssertRulesetRuleType] | None
    rulesetId: fhirtypes.IdType | None
    rulesetId__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    @classmethod
    def elements_sequence(cls): ...
    def get_required_fields(self) -> list[tuple[str, str]]: ...
...
class TestScriptSetupActionAssertRulesetRule(backboneelement.BackboneElement):
    __resource_type__: str
    param: list[fhirtypes.TestScriptSetupActionAssertRulesetRuleParamType] | None
    ruleId: fhirtypes.IdType | None
    ruleId__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    @classmethod
    def elements_sequence(cls): ...
