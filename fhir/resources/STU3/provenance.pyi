...
class Provenance(domainresource.DomainResource):
    ...
    activity: fhirtypes.CodingType | None
    ...
    reason: list[fhirtypes.CodingType] | None
...
class ProvenanceAgent(backboneelement.BackboneElement):
    ...
    relatedAgentType: fhirtypes.CodeableConceptType | None
...
class ProvenanceEntity(backboneelement.BackboneElement):
    ...
    whatIdentifier: fhirtypes.IdentifierType | None
    whatReference: fhirtypes.ReferenceType | None
    whatUri: fhirtypes.UriType | None
    whatUri__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    @classmethod
    def elements_sequence(cls): ...
    def get_required_fields(self) -> list[tuple[str, str]]: ...
    def get_one_of_many_fields(self) -> dict[str, list[str]]: ...
