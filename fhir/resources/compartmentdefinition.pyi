...
class CompartmentDefinitionResource(backboneelement.BackboneElement):
    ...
    endParam: fhirtypes.UriType | None
    endParam__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    param: list[fhirtypes.StringType | None] | None
    param__ext: list[fhirtypes.FHIRPrimitiveExtensionType | None] | None
    startParam: fhirtypes.UriType | None
    startParam__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    @classmethod
    def elements_sequence(cls): ...
    def get_required_fields(self) -> list[tuple[str, str]]: ...
