...
class Transport(domainresource.DomainResource):
    ...
    completionTime: fhirtypes.DateTimeType | None
    completionTime__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    currentLocation: fhirtypes.ReferenceType
    ...
    history: fhirtypes.ReferenceType | None
    identifier: list[fhirtypes.IdentifierType] | None
    input: list[fhirtypes.TransportInputType] | None
    ...
    output: list[fhirtypes.TransportOutputType] | None
    ...
    reason: fhirtypes.CodeableReferenceType | None
    relevantHistory: list[fhirtypes.ReferenceType] | None
    requestedLocation: fhirtypes.ReferenceType
    requester: fhirtypes.ReferenceType | None
    restriction: fhirtypes.TransportRestrictionType | None
