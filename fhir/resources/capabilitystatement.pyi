...
class CapabilityStatement(domainresource.DomainResource):
    ...
    acceptLanguage: list[fhirtypes.CodeType | None] | None
    acceptLanguage__ext: list[fhirtypes.FHIRPrimitiveExtensionType | None] | None
...
class CapabilityStatementRestResource(backboneelement.BackboneElement):
    ...
    conditionalPatch__ext: fhirtypes.FHIRPrimitiveExtensionType | None
