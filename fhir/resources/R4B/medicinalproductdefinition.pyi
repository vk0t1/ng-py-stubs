...
class MedicinalProductDefinitionName(backboneelement.BackboneElement):
    __resource_type__: str
    countryLanguage: list[fhirtypes.MedicinalProductDefinitionNameCountryLanguageType] | None
    namePart: list[fhirtypes.MedicinalProductDefinitionNameNamePartType] | None
