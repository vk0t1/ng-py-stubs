...
class ConceptMap(domainresource.DomainResource):
    ...
    sourceCanonical: fhirtypes.CanonicalType | None
    sourceCanonical__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    sourceUri: fhirtypes.UriType | None
    sourceUri__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    status: fhirtypes.CodeType | None
    status__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    targetCanonical: fhirtypes.CanonicalType | None
    targetCanonical__ext: fhirtypes.FHIRPrimitiveExtensionType | None
