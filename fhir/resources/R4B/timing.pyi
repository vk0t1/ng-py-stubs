...
class TimingRepeat(element.Element):
    ...
    count: fhirtypes.PositiveIntType | None
    count__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    countMax: fhirtypes.PositiveIntType | None
    ...
    frequency: fhirtypes.PositiveIntType | None
    frequency__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    frequencyMax: fhirtypes.PositiveIntType | None
