...
class ElementDefinition(backboneelement.BackboneElement):
    ...
    defaultValueContributor: fhirtypes.ContributorType | None
    ...
    fixedContributor: fhirtypes.ContributorType | None
    ...
    patternContributor: fhirtypes.ContributorType | None
