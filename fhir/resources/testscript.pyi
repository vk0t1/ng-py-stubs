...
class TestScript(domainresource.DomainResource):
    ...
    scope: list[fhirtypes.TestScriptScopeType] | None
...
class TestScriptScope(backboneelement.BackboneElement):
    __resource_type__: str
    artifact: fhirtypes.CanonicalType | None
    artifact__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    conformance: fhirtypes.CodeableConceptType | None
...
class TestScriptSetupActionAssert(backboneelement.BackboneElement):
    ...
    defaultManualCompletion: fhirtypes.CodeType | None
    defaultManualCompletion__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    description: fhirtypes.StringType | None
    description__ext: fhirtypes.FHIRPrimitiveExtensionType | None
    ...
    requirement: list[fhirtypes.TestScriptSetupActionAssertRequirementType] | None
    ...
    stopTestOnFail__ext: fhirtypes.FHIRPrimitiveExtensionType | None
