...
class OperationDefinitionParameter(backboneelement.BackboneElement):
    __resource_type__: str
    allowedType: list[fhirtypes.CodeType | None] | None
    allowedType__ext: list[fhirtypes.FHIRPrimitiveExtensionType | None] | None
    ...
    scope: list[fhirtypes.CodeType | None] | None
    scope__ext: list[fhirtypes.FHIRPrimitiveExtensionType | None] | None
