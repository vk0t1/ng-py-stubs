...
class ActivityDefinition(domainresource.DomainResource):
    ...
    observationRequirement: list[fhirtypes.CanonicalType | None] | None
    observationRequirement__ext: list[fhirtypes.FHIRPrimitiveExtensionType | None] | None
    observationResultRequirement: list[fhirtypes.CanonicalType | None] | None
    observationResultRequirement__ext: list[fhirtypes.FHIRPrimitiveExtensionType | None] | None
    ...
    specimenRequirement: list[fhirtypes.CanonicalType | None] | None
    specimenRequirement__ext: list[fhirtypes.FHIRPrimitiveExtensionType | None] | None
